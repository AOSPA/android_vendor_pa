...
class CameraAction(context: Context) : AuxiliaryAction(context) {

    private val powerManager: PowerManager = context.systemService()
    private val statusBarManager by lazy { LocalServices.getService(StatusBarManagerInternal::class.java) }
